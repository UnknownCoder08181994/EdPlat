/* Video card rendering for ModuleCoach (split from viewer-chat.js) */

ModuleCoach.prototype.appendVideoCard = function(container, video) {
    ...
    card.innerHTML =
        ...
        '<div class="msg-video-wrapper">' +
            '<div class="msg-video-inner">' +
                '<video class="msg-video-player" preload="metadata">' +
