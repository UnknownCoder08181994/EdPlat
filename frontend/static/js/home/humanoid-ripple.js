/* ============================================
   Humanoid Card Reveal Controller
   - No-video mode: cards animate in on section entry
   - Lab bg shown directly, no wave transition
   Extension: humanoid-ripple-ext.js (content animation + reset)
   ============================================ */

class HumanoidCardReveal {
    constructor() {
        this.cards = document.querySelectorAll('.hcard');
        this.backdrop = document.getElementById('humanoid-cards-backdrop');
        this.vid = document.querySelector('.humanoid-vid');
        this.fired = false;
        this.checking = false;
        ...
        document.addEventListener('section-revealed', (e) => {
            ...
            if (e.detail.index === 1) {
                ...
                if (section) {
                    ...
                    // Reveal header
                    const header = section.querySelector('.humanoid-header');
    ...
    rematerializeBackdrop() {
        ...
        const animate = (now) => {
            ...
            if (progress < 1) {
                ...
                // Bluefield now covers everything — pause humanoid video
    ...
    spawnMeshBurst(card) {
        ...
        const container = card.closest('.humanoid-content') || card.parentElement;
