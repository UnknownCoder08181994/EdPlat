/* ============================================
   AWM V2 — Modules Catalogue Controller
   ============================================ */
    ...
    render() {
        ...
        this.cards.forEach(card => {
            ...
            if (this.activeFilter !== 'all') {
                if (!tags.includes(this.activeFilter)) {
                    show = false;
                }
            }
            ...
            if (this.activeTopic && show) {
                if (!tags.includes(this.activeTopic)) {
                    show = false;
                }
            }
        ...
        // Update count
        this.countEl.textContent = visible + (visible === 1 ? ' Module' : ' Modules');
